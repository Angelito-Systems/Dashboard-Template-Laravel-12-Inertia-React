...
const AlertIcons: Record<AlertType, React.ReactNode> = {
  ...
  info: <InfoIcon className="text-blue-500 h-5 w-5" />,
};
...
export function showAlert(options: AlertOptions): void {
  ...
  // Corregimos la función para que coincida con lo que toast.custom espera
  toast.custom((id) => {
    return (
      <div
        className={`flex w-full max-w-sm gap-3 rounded-lg border p-4 shadow-md ${alertStyles[type]} animate-in fade-in`}
      >
